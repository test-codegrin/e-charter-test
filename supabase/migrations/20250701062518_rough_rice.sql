...
CREATE INDEX IF NOT EXISTS idx_drivers_registration_type ON drivers(registration_type);
CREATE INDEX IF NOT EXISTS idx_drivers_status_type ON drivers(status, registration_type);
CREATE INDEX IF NOT EXISTS idx_fleet_documents_driver ON fleet_documents(driver_id);
CREATE INDEX IF NOT EXISTS idx_fleet_service_areas_driver ON fleet_service_areas(driver_id);
CREATE INDEX IF NOT EXISTS idx_fleet_certifications_driver ON fleet_certifications(driver_id);
CREATE INDEX IF NOT EXISTS idx_fleet_references_driver ON fleet_references(driver_id);