...
const DriverViewTripDetails = () => {
  ...
  const fetchTripDetails = async () => {
    try {
      setLoading(true);
      const response = await driverAPI.getTripById(trip_id);
  ...
  const getTripTypeBadge = (type) => {
    const typeMap = {
      single_trip: { label: 'Single Trip', color: 'bg-blue-100 text-blue-800 border-blue-300' },
      round_trip: { label: 'Round Trip', color: 'bg-purple-100 text-purple-800 border-purple-300' },
      multi_stop: { label: 'Multi-Stop', color: 'bg-orange-100 text-orange-800 border-orange-300' },
    };

    const typeInfo = typeMap[type] || { label: type, color: 'bg-gray-100 text-gray-800 border-gray-300' };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-secondary-600">View your trip information</p>
          </div>
        </div>
      ...
      <div className="space-y-6">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-green-50 rounded-lg p-4 border-2 border-green-200 w-full">
                      <span className="text-xs font-bold text-green-700 uppercase tracking-wide block mb-2">Pickup</span>
                      <p className="text-gray-900 font-semibold text-sm mb-2 line-clamp-2">{trip.pickup_location_name}</p>
                      ...
                      <div key={stop.trip_stop_id} className="flex-1 min-w-0">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-200 w-full">
                            ...
                            <p className="text-gray-900 font-semibold text-sm mb-2 line-clamp-2">{stop.stop_location_name}</p>
                            {stop.stop_date && (
                              <div className="flex items-center space-x-1 text-xs text-gray-600">
                                <Calendar className="w-3 h-3" />
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-red-50 rounded-lg p-4 border-2 border-red-200 w-full">
                      <span className="text-xs font-bold text-red-700 uppercase tracking-wide block mb-2">Drop-off</span>
                      <p className="text-gray-900 font-semibold text-sm mb-2 line-clamp-2">{trip.dropoff_location_name}</p>
        ...
        {(trip.trip_rating || trip.trip_review) && (
          <div className="bg-yellow-50 rounded-lg shadow-md p-6 border-2 border-yellow-200 transition-all hover:shadow-lg">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              {trip.trip_rating && (
                <div className="flex-shrink-0">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm border border-yellow-300">
              ...
              {trip.trip_review && (
                <div className="flex-1">
                  ...
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-yellow-300">
        ...
        {/* Customer Information Card - Simplified for Driver */}
        {trip.user_details && trip.user_details.user_id && (
          <div className="bg-blue-50 rounded-lg shadow-md p-6 border-2 border-blue-200 transition-all hover:shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-900 font-mono">#{trip.user_details.user_id}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {trip.vehicle_details && trip.vehicle_details.vehicle_id && (
          <div className="bg-purple-50 rounded-lg shadow-md p-6 border-2 border-purple-200 transition-all hover:shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        <div className="bg-green-50 rounded-lg shadow-md p-6 border-2 border-green-200 transition-all hover:shadow-lg">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
...
export default DriverViewTripDetails;
